...
#goal points
x_goals     = [250,350,300,150,450]
y_goals     =   [250,350,300,150,450]
...
def inverse_kinematics(Count,motion_msg,Limit):
	...
	# print(Error)
	if abs(Error.theta)<0.1  and abs(Error.x)<10 and abs(Error.y)<10:
...
def main():
	...
	while not rospy.is_shutdown():
		...
		inverse_kinematics(Count,Motion_msg,Limit)
