...
def function_mode():
	...
	for sample in range(0,314*2*4):
		t = sample/400
		xList.append(100*math.cos(t)+249.5)
		yList.append(50*math.sin(2*t)+249.5)
...
def image_mode():
	...
	contours = [contours[i]for i in [1]]
